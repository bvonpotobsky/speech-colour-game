...
const colorsByLength = Object.keys(colors).sort((a, b) => a.length - b.length); // console.log(colorsByLength);
...
function handleResult({
  ...
  console.log(color); // check if its a valid colour

  if (!(0, _colors.isValidColor)(color)) return; // if it is, then show the UI for that

  const colorSpan = document.querySelector(`.${color}`);
  colorSpan.classList.add('got'); //   Change the background color

  document.body.style.backgroundColor = color; // console.log(colorSpan);

  console.log('This is a valid color');
}
},{"./colors":"js/colors.js"}],"js/speech.js":[function(require,module,exports) {
"use strict";
...
function start() {
  // see if the browsers support this
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/speech.js"], null)
//# sourceMappingURL=/speech.1370034e.js.map